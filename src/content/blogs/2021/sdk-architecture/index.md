...
description: "介绍可扩展性较好的SDK架构，monorepo、可插拔的插件思路、@mitojs/core核心设计，以及浏览器和微信小程序的整体架构"
tags: ['SDK', '前端监控', '架构']
pubDate: '2021-10-01'
---
...
![wx-mini-architecture](./08-wx-mini-architecture.webp)
