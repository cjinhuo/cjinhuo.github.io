    ...
    _transform(item, encoding, callback) {
        ...
        item.video.forEach((video) => {
            ...
            if (video.view_count !== undefined) {
                this.push((0, sitemap_xml_1.element)(types_1.TagNames['video:view_count'], String(video.view_count)));
            }
            ...
            if (video.gallery_loc) {
                this.push((0, sitemap_xml_1.element)(types_1.TagNames['video:gallery_loc'], attrBuilder(video, 'gallery_loc:title'), video.gallery_loc));
            }
            if (video.price) {
